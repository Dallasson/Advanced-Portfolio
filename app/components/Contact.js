  ...
  return (
    <div className="flex flex-col mt-20 px-10 justify-center ">
      ...
      <div className="flex flex-row justify-between gap-5 mt-20">
        <div
          className="flex flex-col bg-[#171b23] border border-[#838a95] p-5 rounded-2xl flex-1
                     hover:shadow-lg hover:shadow-[#1d60c260]"
        >
          <div className="flex flex-row gap-5 items-center">
            <div className="p-5 bg-[#162237] rounded-full">
              <svg
      ...
      <div
        className="flex flex-col border border-[#838a95] rounded-lg mt-20 hover:shadow-lg hover:shadow-[#1d60c260] transition-all
        justify-center items-center gap-5 py-10 bg-[#171b23]"
      >
        <div className="p-5 bg-[#162237] rounded-full w-fit mt-10">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width={25}
            height={25}
